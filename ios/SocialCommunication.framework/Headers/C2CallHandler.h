...
@property(strong) NSString			*sessionId, *c2apiUrl, *userCreditsString, *infoServiceVersion, *infoServiceUrl, *callMeLink, *c2callUserid, *email, *ownNumber, *didNumber;
...
-(void) submitNumberVerification:(NSString *) phoneNumber;
